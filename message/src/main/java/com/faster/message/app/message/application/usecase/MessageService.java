...
public interface MessageService {
  ...
  PageResponse<PGetAllMessageResponseDto> getAllMessage(String targetSlackId, String content, String messageType, LocalDate sendAt, Integer page, Integer size);
}
